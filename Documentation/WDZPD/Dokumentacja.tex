...
\newline Aplikacja raz dziennie zbiera wszystkie informacje na temat produktów dodanych w magazynach, sprawdza daty przydatności i wysyła spersonalizowane powiadomienia mailowe z informacją, który składnik przeterminuje się lub który już jest przeterminowany. 
\newline Gotowa aplikacja przystosowana będzie typowo pod miłośników piwowarstwa, więc użytkownicy, przy dodawaniu przedmiotów do swoich magazynów, będą mogli wybierać predefiniowane składniki tylko z kategorii "Piwowarstwa", jednak aplikacja zostanie stworzona w taki sposób, aby umożliwić przyszłościowo rozbudowanie blibliotek produktowych o np. ''Nabiał'', czy ''produkty mięsne''.
