...
\begin{document}
	...
	\section{Prezentacja firmy}
		\indent UNI-PLAST to firma zajmująca się sprzedażą oraz montażem wszelkiego rodzaju stolarki otworowej tj. stolarki PVC, drewnianej, aluminiowej, rolet zewnętrznych,
			...
			wykonanych z wszelakich materiałów (granitów, marmurów, konglomeratów czy kwarców). Firma posiada swoją siedzibę Lubaniu, przy ulicy Dąbrowskiego 2, swoją działalność prowadzi
			na terenie województwa dolnośląskiego, lubuskiego, wielkopolskiego i opolskiego a także od 2018 roku na terenie Niemiec i Czech. Firma UNI-PLAST obsługuje zarówno klientów
			indywidualnych jak i klientów inwestycyjnych. Przedsiębiorstwo posiada również swoją stronę internetową znajdującą się pod adresem: \url{https://www.uni-plast.eu/},
		...
		\indent Część biurowa zajmuje się wszelkiego rodzaju doradztwem technicznym, pozyskiwaniem klienta, obsługą reklamacji a przede wszystkim koordynacji zamówień,
			...
			Pracownicy biurowi zajmują się również częścią logistyczną polegająca na ustaleniu optymalnej trasy montażowej, serwisowej. Dodatkowo muszą zadbać o w miarę oszczędną trasę
		...
		\indent Część magazynowa i montażowa zajmuje się przyjmowaniem towaru, wykonywanie serwisów, napraw i montażem wszystkich wymienionych wyżej elementów bezpośrednio
			u klienta.
	\newpage
